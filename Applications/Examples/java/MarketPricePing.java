...
public class MarketPricePing {
	...
	public static long pingSendTime = 0;
    public static long pingTimeoutInterval = 30;
    public static long pingTimeoutTime = 0;
        ...
        try {
			...
			while(true) {
				...
				if(pingTimeoutTime > 0 && System.currentTimeMillis() > pingTimeoutTime) {
					System.out.println("No ping from server, timing out");
                    ws.disconnect();
                    break;
				}
			}
