...
namespace MarketPriceRTOAuthenticationExample
{
    static class Policy
    {
    ...
    class MarketPriceRTOAuthenticationExample
    {
        ...
        {
            MarketPriceRTOAuthenticationExample example = new MarketPriceRTOAuthenticationExample();
