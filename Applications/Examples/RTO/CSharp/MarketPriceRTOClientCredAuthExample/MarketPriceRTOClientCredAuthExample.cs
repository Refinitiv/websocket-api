...
namespace MarketPriceRTOClientCredAuthExample
{
    class MarketPriceRTOClientCredAuthExample
    {
        ...
        {
            MarketPriceRTOClientCredAuthExample example = new MarketPriceRTOClientCredAuthExample();
