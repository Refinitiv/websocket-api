...
"""
  ...
  or refresh_token grant token in auth request to LDP (auth/oauth2/v1/token) using 
...
def query_service_discovery(url=None):
    ...
    print("Sending LSEG Delivery Platform service discovery request to " + url)
    ...
    if r.status_code == 200:
        ...
        print("LSEG Delivery Platform Service discovery succeeded. RECEIVED:")
...
def get_sts_token(current_refresh_token, url=None):
    ...
    if r.status_code == 200:
        ...
        time.sleep(5)
        # CAUTION: This is sample code with infinite retries.
        print('Retrying auth request to LSEG Delivery Platform')
        return get_sts_token(current_refresh_token)


def print_commandline_usage_and_exit(exit_code):
    print('Usage: market_price_rto_service_discovery.py [--app_id app_id] '
...
if __name__ == "__main__":
    ...
    # Query VIPs from LSEG Delivery Platform service discovery
